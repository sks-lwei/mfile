...
public class SysCache {
    ...
    @Resource
    private DriverConfigMapper driverConfigMapper;

    /**
     * 缓存过期时间
     */
    @Value("${mfile.cache.timeout}")
    private long timeout;

    /**
     * 缓存自动刷新间隔
     */
    @Value("${mfile.cache.auto-refresh.interval}")
    ...
    public List<FileItemDTO> find(Integer driveId, String key) {
        ...
        DriveConfig driveConfig = driverConfigMapper.selectById(driveId);
